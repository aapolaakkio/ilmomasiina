...
ARG DATABASE_URL
ARG NEW_EDIT_TOKEN_SECRET=build-placeholder
ARG AUTH_SECRET=build-placeholder
ARG AUTH_GOOGLE_ID=build-placeholder
ARG AUTH_GOOGLE_SECRET=build-placeholder
ARG MAIL_FROM=build@placeholder
ARG BRANDING_MAIL_FOOTER_TEXT=placeholder
ARG BRANDING_MAIL_FOOTER_LINK=https://placeholder
ARG BASE_URL=http://localhost:3000
ARG CRON_SECRET=build-placeholder
ENV DATABASE_URL=${DATABASE_URL}
ENV NEW_EDIT_TOKEN_SECRET=${NEW_EDIT_TOKEN_SECRET}
ENV AUTH_SECRET=${AUTH_SECRET}
ENV AUTH_GOOGLE_ID=${AUTH_GOOGLE_ID}
ENV AUTH_GOOGLE_SECRET=${AUTH_GOOGLE_SECRET}
ENV MAIL_FROM=${MAIL_FROM}
ENV BRANDING_MAIL_FOOTER_TEXT=${BRANDING_MAIL_FOOTER_TEXT}
ENV BRANDING_MAIL_FOOTER_LINK=${BRANDING_MAIL_FOOTER_LINK}
